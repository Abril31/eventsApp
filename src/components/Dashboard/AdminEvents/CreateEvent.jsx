...
const CreateEvent = () => {
  ...
  const onSubmit = async (event) => {
    ...
    try {
      await api.post("/registerevent", formData);
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className={styles.formControl}>
          ...
          {formErrors.start_date && (
            <p className={styles.errors}>{formErrors.start_date}</p>
          )}
        </div>
        ...
        <div className={styles.formControl}>
          ...
          />
          {formErrors.end_date && (
            <p className={styles.errors}>{formErrors.end_date}</p>
          )}
        </div>
        ...
        <div className={styles.formControl}>
          ...
          {formErrors.start_hour && (
            <p className={styles.errors}>{formErrors.start_hour}</p>
          )}
        </div>
        ...
        <div className={styles.formControl}>
          ...
          />
          {formErrors.end_hour && (
            <p className={styles.errors}> {formErrors.end_hour}</p>
          )}
        </div>
        ...
        <div className={styles.formControl}>
          ...
          />
          {formErrors.location && (
            <p className={styles.errors}> {formErrors.location}</p>
          )}
        </div>
        ...
        <div className={styles.formControl}>
          ...
          />
          {formErrors.city && (
            <p className={styles.errors}>{formErrors.city}</p>
          )}
        </div>
        ...
        <div>
          ...
          />
          {previewImage && (
            <img src={previewImage} alt="Vista Previa" width={"200px"} />
          )}
          {formErrors.image && (
        ...
        <div className={styles.formControl}>
          ...
          />
          {formErrors.category && (
            <p className={styles.errors}>{formErrors.category}</p>
          )}
        </div>
        ...
        <div className={styles.formControl}>
          ...
          {formErrors.id_sponsor && (
            <p className={styles.errors}>{formErrors.id_sponsor}</p>
          )}
        </div>
        ...
        <div className={styles.formControl}>
          ...
          >
            ...
            <option value="paid" className={styles.option}>
              PAID
            </option>
            <option value="free" className={styles.option}>
              FREE
            </option>
          </select>
          {formErrors.access && (
            <p className={styles.errors}>{formErrors.access}</p>
          )}
        </div>
        <div className={styles.formControl}>
          <label className={styles.available_quantity}>
            Cantidad de tickets a la venta:{" "}
          </label>
          <input
            type="number"
          ...
          {formErrors.available_quantity && (
            <p className={styles.errors}> {formErrors.available_quantity}</p>
          )}
        </div>
