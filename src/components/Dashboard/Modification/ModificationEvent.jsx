...
const ModificationProduct = () => {
  ...
  useEffect(() => {
    const fetchProductData = async () => {
      try {
        const response = await api.get(`/getallevents/productos/${id}`);
  ...
  useEffect(() => {
    const fetchCategorias = async () => {
      try {
        const response = await api.get(`/getallevents/categorias`);
  ...
  useEffect(() => {
    const fetchFabricantes = async () => {
      try {
        const response = await api.get(`/getallevents/fabricantes`);
  ...
  useEffect(() => {
    const fetchMarcas = async () => {
      try {
        const response = await api.get(`/getallevents/marcas`);
  ...
  const onSubmit = async (event) => {
    ...
    try {
      await api.put(`/getallevents/productos/change/${id}`, {
        ...formData,
      });
    } catch (error) {
