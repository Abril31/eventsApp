...
const stripePromise = loadStripe("pk_test_51P1uzsRtxcncuebvqofmHPj5v0MnrsAj3c5rUj4GtgrE0Pj3LcCmd1Mxdx0wf1kj5AuTd7WR6fIEiIPFOquAvl5i0060tOGXTS"); // Reemplaza "pk_test_tu_clave_publica" con tu clave pública de Stripe
    ...
    decrementCount: () =>
      ...
      checkout: async (totalAmount) => {
        ...
        try {
          ...
          const eventNames = get().cartTickets.map((item) => item.eventName).join(", "); // Convierte la lista de nombres de eventos en una cadena separada por comas
